...
if(isset($_POST['register'])){
    ...
    $sql = "SELECT COUNT(username) AS num FROM customers WHERE username = :username";
    ...
    $sql = "INSERT INTO customers (firstname, lastname, username, password, address, postcode) VALUES (:firstname, :lastname, :username, :password, :address, :postcode)";
    $stmt = $pdo->prepare($sql);
