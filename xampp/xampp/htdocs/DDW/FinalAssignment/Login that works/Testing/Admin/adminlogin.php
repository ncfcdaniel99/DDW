...
<nav class="navbar navbar-expand-sm navbar-dark fluid">
 ...
 <h1> Automobile Trader </h1>
  ...
  <ul class="navbar-nav">
    ...
    <div class="form">
        ...
        <form action="adminloggingin.php" method="post">

			 	<div class="outputresults">
            <label for="username">Username</label>
            <input type="text" id="username" name="username" class="form-control" placeholder="Enter your username"><br>
			</div>
			 	<div class="outputresults">
  ...
  <input type="checkbox" name="savecookie"> I want to login
 <input type="submit"  class="btn btn-danger"  value="Submit">
  ...
  <input type="submit" class="btn btn-danger" onclick="window.location.href = 'adminregister.php';" value="Admin Sign up">
    </div>
